/**
 * integrations/ghl.js
 * GoHighLevel API integration — push permit + PA data to contact custom fields.
 */
...
async function pushPermitData(contactId, payload) {
  ...
  addField('permit_roof_age',           roofScore.age !== null ? `${roofScore.age} años` : '');
  ...
  if (acPerm) {
    addField('permit_ac_age',        acPerm._age !== null ? `${acPerm._age} años` : '');
  ...
  if (elPerm) {
    addField('permit_electric_age',        elPerm._age !== null ? `${elPerm._age} años` : '');
  ...
  addField('pa_homestead',       property.homestead ? 'Sí' : 'No');
